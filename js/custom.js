  ...
  var Core = {
    ...
    carouselSlider: function(){
      ...
      $(".js_widget-carousel").owlCarousel({
        ...
        navText : ["<span class='dotted-link2'><i class='fa fa-chevron-left'></i> <span>Anterior</span></span>","<span class='dotted-link2'><span>Siguiente</span> <i class='fa fa-chevron-right'></i></span>"]
      });
